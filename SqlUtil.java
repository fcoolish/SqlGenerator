...
public class SqlUtil {
    ...
    public static void main(String[] args) {
        ...
        String packageName = "/Users/fcoolish/Desktop/work/src/main/java/com/work/server/web/entity";
        //生成sql的文件夹
        String filePath = "/Users/fcoolish/Desktop/work";
        //项目中实体类的路径
        String prefix = "com.work.server.web.entity.";
        String className = "";
        ...
        StringToSql(sqls.toString(), filePath + "work.sql");
